...
const Hero = () => {
  ...
  return (
    ...
    >
      <div className="w-full max-w-screen-2xl mx-auto flex flex-col lg:flex-row items-center min-h-screen lg:min-h-0 py-20 lg:py-0">
        ...
        <div className="w-full lg:w-1/2 flex flex-col items-start justify-center px-6 lg:px-12 py-8 lg:py-20 relative order-2 lg:order-1">
          ...
          <div className="max-w-[560px] w-full">
            <h1 data-aos="fade-right" className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-5 lg:mb-6 leading-tight">
              <span className="block">Data Speaks.</span>
              <span className="block">I Translate.</span>
            </h1>

            <p data-aos="fade-right" data-aos-delay="120" className="text-white/90 text-base lg:text-lg leading-relaxed mb-8">
            ...
            <div data-aos="fade-up" data-aos-delay="240" className="flex items-center gap-3 lg:gap-4">
              <a href="#projects" className="inline-flex items-center justify-center rounded-full bg-white text-red-600 px-6 lg:px-6 py-3 lg:py-3 text-base font-bold shadow-lg transition duration-300 hover:-translate-y-1 hover:bg-gray-100">
                View Projects
              </a>
              <a href="#contact" className="inline-flex items-center justify-center rounded-full border border-white/40 bg-transparent px-6 lg:px-6 py-3 lg:py-3 text-base font-semibold text-white transition duration-300 hover:-translate-y-1 hover:bg-white/10">
                Contact
              </a>
            </div>
          </div>
